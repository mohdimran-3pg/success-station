  ...
  return (
    ...
    <View style={{ width:'47%',margin:'1.5%', borderColor: "#00000030", borderWidth: 1, borderRadius: 4}}>
        ...
        <View style={{height: 40, marginTop:7}}>
          ...
          <Text style={{fontSize: 15, fontWeight: "400", textAlign: "center", color: "#9EA6BE",marginTop:9, fontFamily: "DMSans-Regular", paddingLeft: 10, paddingRight: 10}} ellipsizeMode='tail' numberOfLines={1}>{user.email}</Text>
        </View>
